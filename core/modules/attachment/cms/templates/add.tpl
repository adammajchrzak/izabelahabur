...
<form id="form-edit-news" name="form-edit-news" method="post" action="/{$router->getUrl('cms','price','edit')}">
	...
	<h2 class="thin float-left">Dodaj lokal</h2>
	...
	<fieldset class="fieldset fields-list">
		<p class="inline-large-label button-height">
			...
			<input type="text" id="_local" name="_local" value="" class="input full-width" />
		</p>
		<p class="inline-large-label button-height">
			...
			<select id="_floor" name="_floor" class="select check-list">
				...
				<option value="{$cl.item_id}">{$cl._name}</option>
				{/foreach}
			</select>
		</p>
		<p class="inline-large-label button-height">
		...
		<p class="inline-large-label button-height">
			...
			<input type="text" id="_area" name="_area" value="" class="input full-width" />
		</p>
		<p class="inline-large-label button-height">
			<label class="label">Balkon m<sup>2</sup></label>
			<input type="text" id="_balcony" name="_balcony" value="" class="input full-width" />
		</p>
		<p class="inline-large-label button-height">
			<label class="label">Lokal dostępny</label>
			<input id="_available" name="_available" type="checkbox" value="1"{if $item._available == '1'} checked{/if} class="switch" data-text-on="TAK" data-text-off="NIE" />
		</p>
		<p class="inline-large-label button-height">
			<label class="label">Antresola</label>
			<input id="_entresol" name="_entresol" type="checkbox" value="1"{if $item._entresol == '1'} checked{/if} class="switch" data-text-on="TAK" data-text-off="NIE" />
		</p>
		<p class="inline-large-label button-height">
			<label class="label">Taras</label>
			<input id="_terrace" name="_terrace" type="checkbox" value="1"{if $item._terrace == '1'} checked{/if} class="switch" data-text-on="TAK" data-text-off="NIE" />
		</p>
		<p class="inline-large-label button-height">
			<label class="label">Ogród</label>
			<input id="_garden" name="_garden" type="checkbox" value="1"{if $item._garden == '1'} checked{/if} class="switch" data-text-on="TAK" data-text-off="NIE" />
		</p>
		<p class="inline-large-label button-height">
			<label class="label">Rzut marketingowy</label>
			<input id="_file" name="_file" type="text" value="{$item._file}" class="input full-width"/>
		</p>
	</fieldset>
</form>
</div>
